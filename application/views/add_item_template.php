                        ...
                        <div class="panel-body">
                            ...
                            <input type="hidden" name="data[file_list]" id="file_list" value="{post_data[file_list]}">
                              ...
                              <div class="form-group">
							   ...
							   <div class="form-group">
                                <label for="goods-weight" class="col-lg-1 control-label">商品推荐值</label>
                                <div class="col-lg-4">
                                  <input type="weight" min="1" name="data[weight]" class="form-control" id="goods-weight" value=1 required placeholder="商品推荐值">
                                </div>
                              </div>
                              ...
                              <div class="form-group">
                                <div class="col-lg-offset-1 col-lg-4">
                                  <button type="submit" id="goods-save" class="btn btn-primary">确认新增</button>
                                  <a  id="goods-save" class="btn btn-primary" onclick="javascript:$('#file_upload').uploadifive('cancel')">cancel</a>
                                </div>
                              </div>
                            </form>
                        </div>
